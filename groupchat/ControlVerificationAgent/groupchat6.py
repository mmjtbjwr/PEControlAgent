...
def manager_response(self, messages, sender, config):
    if state_manager.state == "initial":
        ...
        4. Optimized Controller Parameters:
           Voltage PI: Kp = {verification_result.best_params['voltage_k']:.4f}, Ki = {verification_result.best_params['voltage_k'] / verification_result.best_params['voltage_Ti']:.4f}
           Current PI: Kp = {verification_result.best_params['current_k']:.4f}, Ki = {verification_result.best_params['current_k'] / verification_result.best_params['current_Ti']:.4f}
