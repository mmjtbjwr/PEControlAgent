model boost_converter
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitor(          v(start=170), C=0.002)                                                                     annotation (
  ...
  Modelica.Electrical.Analog.Basic.Resistor resistor(R=20000) annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={78,38})));
